    ...
    <div class="col">
      <form method="POST" action="{{ route('user.store') }}" id="form-create" class="needs-validation" accept-charset="UTF-8" enctype="multipart/form-data" novalidate>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" name="name" id="name" class="form-control" value="" placeholder="{{ __('Please Enter Name') }}" required>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" name="username" id="username" class="form-control" value="" placeholder="{{ __('Please Enter Username') }}" required>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" name="phone" id="phone" class="form-control" value="" placeholder="{{ __('Please Enter Phone') }}" required>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="email" name="email" id="email" class="form-control" value="" placeholder="{{ __('Please Enter Email') }}" required>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <div class="input-group has-validation">
              <input type="password" name="password" id="password" class="form-control" value="" placeholder="{{ __('Please Enter Password') }}" required>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <div class="input-group has-validation">
              <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" value="" placeholder="{{ __('Please Enter Password Confirmation') }}" required>
              <span class="input-group-text">
                <i class="fa-solid fa-eye showEye"></i>
                <i class="fa-solid fa-eye-slash hideEye" style="display:none;"></i>
              </span>
